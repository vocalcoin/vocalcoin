...
const string strMessageMagic = "vocal Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
        ...
        {
            nSubsidy = 28000000 * COIN; // 28 million coins for ico
        }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "vocal", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Vocal coin november";
        CTransaction txNew;
        txNew.nTime = 1413909220;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	   ...
	   block.nBits    = 0x1e0fffff;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe3668c79367b739ff135b9d3456d5dc6377c441c817d9164a8c70853b8e8fda8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x9c, 0xcd, 0xfa, 0xdf };
